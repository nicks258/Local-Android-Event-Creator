...
/**
 * Created by sumitm on 09-Jun-17.
 */

public class SpinnerListAdapter extends BaseAdapter implements Filterable, ISpinnerSelectedView {
    ...
    public SpinnerListAdapter(Context context, ArrayList<String> strings) {
        mContext = context;
        mStrings = strings;
